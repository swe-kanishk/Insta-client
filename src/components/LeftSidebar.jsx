...
function LeftSidebar() {
  ...
  const logoutHandler = async () => {
    try {
      const res = await axios.get("https://insta-backend-flws.onrender.com/api/v1/user/logout", {
    ...
    <div className="flex h-full">
      ...
      <div
        className={`p-6 w-1/5 border-r border-gray-300 fixed top-0 left-[250px] z-30 h-full bg-white transition-transform duration-300 ${
          openNotificationBar ? "translate-x-0 ease-in delay-200" : "-translate-x-full delay-200"
        }`}
      >
